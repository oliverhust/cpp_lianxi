...
/*****************************************************************************
 ...
 Date Created: 2008/8/6
  ...
  Description: Initialize the singly-linked list node
        Input: None
       Output: OUT SL_NODE_S* pstNode  List node pointer
       Return: No return
      Caution:
------------------------------------------------------------------------------
  Modification History
...
static inline VOID SL_Del_Rcu(IN SL_HEAD_S* pstList, IN const SL_NODE_S* pstNode)
{
    SL_NODE_S *pstCur, *pstPrev;
...
static inline VOID STQ_Del_Rcu(IN STQ_HEAD_S* pstList, IN const STQ_NODE_S* pstNode)
{
    STQ_NODE_S *pstPrev, *pstCur;
...
static inline VOID RWSTQ_Del(IN RWSTQ_HEAD_S* pstList, IN const STQ_NODE_S* pstNode);
...
static inline BOOL_T RWDTQ_IsEndOfQ(IN RWDTQ_HEAD_S* pstList, IN const DTQ_NODE_S* pstNode);
...
static inline VOID RWDTQ_Del(IN RWDTQ_HEAD_S* pstList, IN const DTQ_NODE_S* pstNode);
/*****************************************************************************
